...
* Caua Valim De Sousa Olivio
*
* */


import Persistence.dao.ConnectionFactory;
import Persistence.dao.H2DataBaseStudentDAO;
import Persistence.dao.StudentDAO;
import jakarta.persistence.EntityManager;
import model.Student;
import services.RegisterStudentsService;
import services.RemoveStudentsService;
import services.UpdateStudentsService;
import util.Ui;
...
public class Main {
    public static void main(String[] args) {
        ...
        final RegisterStudentsService registerStudentsService = new RegisterStudentsService(dao);
        final UpdateStudentsService updateStudentsService = new UpdateStudentsService(dao);
        final RemoveStudentsService removeStudentsService = new RemoveStudentsService(dao);
            ...
            do {
                ...
                switch (option) {
                    case 1:
                        ...
                        registerStudentsService.register(newStudent);
                    ...
                    case 2:
                        ...
                        if (target.isPresent()) {
                            removeStudentsService.remove(target.get());
                    ...
                    case 3:
                        ...
                        if (updateStudent.isPresent()) {
                            ...
                            updateStudentsService.update(updateStudent.get(), newName, newRa, newEmail, newGrade1, newGrade2, newGrade3);
                        } else {
                            System.out.println("Aluno não encontrado.");
                        }
                        break;
